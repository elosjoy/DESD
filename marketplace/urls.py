...
urlpatterns = [
    ...
    path("producer/products/<int:product_id>/update-availability/", views.producer_update_product_availability, name="producer_update_product_availability"),
    ...
    path("producer/products/<int:pk>/stock/", views.producer_product_update_stock, name="producer_product_update_stock"),
